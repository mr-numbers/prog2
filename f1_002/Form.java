...
public class Form extends JPanel {   //Tried to design it in such a way that it could be built upon with more types of valuables later. Now you simply add another if-set if that's what you want
